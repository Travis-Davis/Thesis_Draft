...
\acro{DEM}{Discrete Element Model}
\acro{VP}{Non-Linear Viscous Plastic Rheology}
\acro{EVP}{Elastic-Viscous-Plastic}
\acro{MIZ}{Marginal Ice Zone}
\acro{AIDJEX}{Arctic Ice Dynamics Joint Experiment}
\acro{DEMSI}{Discrete Element Model for Sea Ice}
\acro{SNL}{Sandia National Laboratories}
\acro{LNL}{Los Alamos National Laboratory}
